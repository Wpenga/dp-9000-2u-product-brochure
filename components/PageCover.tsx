      ...
      <div className="flex flex-col h-full justify-between pt-10 pb-20">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-slate-50 p-6 rounded-lg border border-slate-100">
            ...
            <h3 className="font-bold text-slate-900 mb-2">国产芯片</h3>
            <p className="text-sm text-slate-500">
              采用飞腾D3000M/8核处理器，主频2.3GHz，安全可靠。
            </p>
          </div>
          <div className="bg-slate-50 p-6 rounded-lg border border-slate-100">
            <Layers className="w-8 h-8 text-brand-600 mb-4" />
            <h3 className="font-bold text-slate-900 mb-2">多系统支持</h3>
            <p className="text-sm text-slate-500">
              支持国产银河麒麟、UOS系统，适配国产化生态。
            </p>
          </div>
          <div className="bg-slate-50 p-6 rounded-lg border border-slate-100">
            ...
            <p className="text-sm text-slate-500">
              IP65防护等级，板载GPS/北斗/GLONASS模块，适应恶劣环境。
            </p>
          </div>
        </div>
